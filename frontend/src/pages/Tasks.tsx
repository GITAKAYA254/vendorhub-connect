    ...
    <main className="flex-1 container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-12 gap-6">
        <div>
          ...
          <h1 className="text-4xl md:text-5xl font-black mb-2 tracking-tight uppercase">Tasks</h1>
          <p className="text-muted-foreground text-lg">Immediate things that need to be done.</p>
        </div>
